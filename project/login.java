...
public void actionPerformed(ActionEvent e4)
     {
       ...
       if(e4.getSource()==b1)
        ...
        if((st1.equals("admin"))&&(st2.equals("mobile")))
          {
        try
           {
        JFrame f=new JFrame("******* Selection Menu *******");

        i1= ImageIO.read(new File("2.jpg"));
	   i2= ImageIO.read(new File("4.jpg"));
    ...
    if(e4.getSource()==b3)
      {
       JOptionPane.showMessageDialog(null,"this is designed by Kushagra sharma ",
